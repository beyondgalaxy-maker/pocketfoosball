...
ROOT=Path(__file__).resolve().parent;OUT=ROOT/'site-check-v13';OUT.mkdir(exist_ok=True)
URL='https://beyondgalaxy-maker.github.io/pocketfoosball/'
ASSETS=['index.html','styles.css','engine.js','app.js','input.js','rolling.js','bot-control.js','v11.js','online.js','v12.js','v13.js']
checks=[]
...
try:
 with sync_playwright() as p:
  ...
  for name,width,height in [('portrait',390,844),('small-phone',320,640),('landscape',844,390),('desktop',1440,900)]:
   ...
   response=page.goto(URL+'?v=13',wait_until='networkidle');page.wait_for_function('window.touchline?.version==="13.0.0"')
   ...
   page.evaluate('touchline.setOverlayOpacity(.12)');page.reload(wait_until='networkidle');page.wait_for_function('window.touchline?.version==="13.0.0"')
   ...
   page.evaluate('touchline.controls12.set({size:66,width:90,lift:8,reach:.5})');page.reload(wait_until='networkidle');page.wait_for_function('touchline.version==="13.0.0"')
