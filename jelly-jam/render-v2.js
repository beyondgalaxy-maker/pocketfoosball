...
class Renderer{
 ...
 for(const q of s.crates){round(c,q.x,q.y,q.w,q.h,5,'#c19461','#876640');c.lineWidth=2;c.strokeStyle='#876640';c.beginPath();c.moveTo(q.x+5,q.y+5);c.lineTo(q.x+q.w-5,q.y+q.h-5);c.moveTo(q.x+q.w-5,q.y+5);c.lineTo(q.x+5,q.y+q.h-5);c.stroke();}
